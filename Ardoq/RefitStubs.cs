...
namespace Ardoq.Service.Interface
{
    ...
    [Preserve]
    public partial class AutoGeneratedINotifyService : INotifyService
    {
        public HttpClient Client { get; protected set; }
        readonly Dictionary<string, Func<HttpClient, object[], object>> methodImpls;

        public AutoGeneratedINotifyService(HttpClient client, IRequestBuilder requestBuilder)
        {
            methodImpls = requestBuilder.InterfaceHttpMethods.ToDictionary(k => k, v => requestBuilder.BuildRestResultFuncForMethod(v));
            Client = client;
        }

        public virtual Task<Message> PostMessage(Message message)
        {
            var arguments = new object[] { message };
            return (Task<Message>) methodImpls["PostMessage"](Client, arguments);
        }
...
namespace Ardoq.Service.Interface
{
    ...
    [Preserve]
    public partial class AutoGeneratedIFolderService : IFolderService
    {
        public HttpClient Client { get; protected set; }
        readonly Dictionary<string, Func<HttpClient, object[], object>> methodImpls;

        public AutoGeneratedIFolderService(HttpClient client, IRequestBuilder requestBuilder)
        {
            methodImpls = requestBuilder.InterfaceHttpMethods.ToDictionary(k => k, v => requestBuilder.BuildRestResultFuncForMethod(v));
            Client = client;
        }

        public virtual Task<List<Folder>> GetAllFolders(string org)
        {
            var arguments = new object[] { org };
            return (Task<List<Folder>>) methodImpls["GetAllFolders"](Client, arguments);
        }

        public virtual Task<Folder> GetFolderById(String id,string org)
        {
            var arguments = new object[] { id,org };
            return (Task<Folder>) methodImpls["GetFolderById"](Client, arguments);
        }

        public virtual Task<Folder> CreateFolder(Folder tag,string org)
        {
            var arguments = new object[] { tag,org };
            return (Task<Folder>) methodImpls["CreateFolder"](Client, arguments);
        }

        public virtual Task<Folder> UpdateFolder(String id,Folder tag,string org)
        {
            var arguments = new object[] { id,tag,org };
            return (Task<Folder>) methodImpls["UpdateFolder"](Client, arguments);
        }

        public virtual Task DeleteFolder(String id,string org)
        {
            var arguments = new object[] { id,org };
